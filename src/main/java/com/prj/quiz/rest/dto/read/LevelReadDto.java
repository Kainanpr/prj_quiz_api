...
public final class LevelReadDto {
    private final Integer id;
    private final String name;

    private LevelReadDto(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public boolean equals(Object o) {
        ...
        LevelReadDto that = (LevelReadDto) o;
    ...
    public static final class Builder implements ObjectBuilder {
        ...
        public LevelReadDto build() {
            ...
            return new LevelReadDto(id, name);
        }
    }
}
