...
public final class StudyReadDto {
    ...
    private StudyReadDto(Integer id, String word, String translation, Integer contentId, Integer levelId) {
        this.id = id;
        this.word = word;
    ...
    public boolean equals(Object o) {
        ...
        StudyReadDto study = (StudyReadDto) o;
    ...
    public static final class Builder implements ObjectBuilder {
        ...
        public StudyReadDto build() {
            ...
            return new StudyReadDto(id, word, translation, contentId, levelId);
        }
    }
}
